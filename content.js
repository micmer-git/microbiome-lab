(function (root, factory) {
  ...
  const SOURCES = {
    ...
    faecalibacterium: "https://pubmed.ncbi.nlm.nih.gov/26045134/",
    roseburia: "https://pubmed.ncbi.nlm.nih.gov/35893896/",
    eubacteriumRectale: "https://pubmed.ncbi.nlm.nih.gov/25388295/",
    anaerobutyricum: "https://pubmed.ncbi.nlm.nih.gov/21388423/",
    bifidoAdolescentis: "https://pubmed.ncbi.nlm.nih.gov/27357127/",
    bifidoLongum1714: "https://pubmed.ncbi.nlm.nih.gov/38355674/",
    bacteroidesThetaPectin: "https://pubmed.ncbi.nlm.nih.gov/28329766/",
    bacteroidesVulgatus: "https://pubmed.ncbi.nlm.nih.gov/27409811/",
    prevotellaContext: "https://pubmed.ncbi.nlm.nih.gov/27409811/",
    blautiaWexlerae: "https://pubmed.ncbi.nlm.nih.gov/35982037/",
    coprococcus: "https://pubmed.ncbi.nlm.nih.gov/35972231/",
    alistipes: "https://pubmed.ncbi.nlm.nih.gov/37254152/",
    parabacteroides: "https://pubmed.ncbi.nlm.nih.gov/30605678/",
    collinsella: "https://pubmed.ncbi.nlm.nih.gov/36558359/",
    bilophila: "https://pubmed.ncbi.nlm.nih.gov/22722865/",
    escherichia: "https://pubmed.ncbi.nlm.nih.gov/30356663/",
    enterococcus: "https://pubmed.ncbi.nlm.nih.gov/25529314/",
  ...
  const SPECIES_INFO = {
    faecalibacterium: { base: "butyrate", affinity: { en: "Acetate-supported fermentation of fibre breakdown products", it: "Fermentazione, sostenuta dall'acetato, dei prodotti derivati dalle fibre" }, source: SOURCES.faecalibacterium, extra: [{ domain: "immune", level: "preclinical", en: "Its MAM protein reduced epithelial NF-κB signalling and experimental colitis; MAM activity differs markedly among strains, so abundance is not an anti-inflammatory dose.", it: "La proteina MAM ha ridotto il segnale epiteliale NF-κB e la colite sperimentale; l'attività di MAM varia molto tra ceppi, quindi l'abbondanza non è una dose antinfiammatoria." }] },
    roseburia: { base: "butyrate", affinity: { en: "Arabinoxylans, β-glucans and other fibre-derived sugars", it: "Arabinoxilani, β-glucani e altri zuccheri derivati dalle fibre" }, source: SOURCES.roseburia, extra: [{ domain: "immune", level: "preclinical", en: "R. intestinalis and its butyrate increased epithelial TLR5 and reduced inflammation in cell and mouse colitis models; no equivalent species supplementation trial exists in humans.", it: "R. intestinalis e il suo butirrato hanno aumentato TLR5 epiteliale e ridotto l'infiammazione in cellule e modelli murini di colite; manca un equivalente trial umano di supplementazione della specie." }] },
    eubacterium: { base: "butyrate", affinity: { en: "Starch fragments and resistant-starch cross-feeding", it: "Frammenti di amido e cross-feeding da amido resistente" }, source: SOURCES.eubacteriumRectale, extra: [{ domain: "digestion", level: "mechanistic", en: "Surface amylases release and capture maltooligosaccharides; it often rises on resistant starch but is not the principal degrader of intact resistant-starch granules.", it: "Amilasi di superficie liberano e catturano maltooligosaccaridi; spesso aumenta con l'amido resistente ma non è il principale degradatore dei granuli intatti." }] },
    anaerobutyricum: { base: "butyrate", affinity: { en: "Lactate plus acetate supplied by primary fermenters", it: "Lattato più acetato forniti dai fermentatori primari" }, source: SOURCES.anaerobutyricum, extra: [{ domain: "digestion", level: "mechanistic", en: "A. hallii consumes both lactate and acetate through the butyryl-CoA:acetate CoA-transferase route to form butyrate, making it a cross-feeder rather than a primary fibre degrader.", it: "A. hallii consuma lattato e acetato tramite la via butirril-CoA:acetato CoA-transferasi formando butirrato: è un cross-feeder, non un degradatore primario delle fibre." }] },
    bifidoAdolescentis: { base: "bifido", affinity: { en: "Inulin, GOS and selected resistant starches", it: "Inulina, GOS e alcuni amidi resistenti" }, source: SOURCES.bifidoAdolescentis, extra: [{ domain: "metabolic", level: "human", en: "In a small resistant-starch intervention, expansion of B. adolescentis or R. bromii characterized participants whose faecal butyrate rose; responses varied substantially between people.", it: "In un piccolo intervento con amido resistente, l'aumento di B. adolescentis o R. bromii caratterizzava i partecipanti con aumento del butirrato fecale; le risposte variavano molto tra persone." }] },
    bifidoLongum: { base: "bifido", affinity: { en: "Oligosaccharides; utilization and host effects vary by strain", it: "Oligosaccaridi; utilizzo ed effetti sull'ospite variano per ceppo" }, source: SOURCES.bifidoLongum1714, extra: [{ domain: "neuro", level: "strain", en: "Eight weeks of the named strain B. longum 1714 improved selected sleep-quality and daytime-function measures, but not the overall sleep score versus placebo; this cannot be inferred from species abundance.", it: "Otto settimane del ceppo B. longum 1714 hanno migliorato alcune misure di qualità del sonno e funzione diurna, ma non il punteggio globale rispetto al placebo; non si può dedurre dall'abbondanza della specie." }] },
    bacteroidesTheta: { base: "saccharolytic", affinity: { en: "Pectin and a wide repertoire of dietary and host glycans", it: "Pectina e un ampio repertorio di glicani alimentari e dell'ospite" }, source: SOURCES.bacteroidesThetaPectin, extra: [{ domain: "digestion", level: "mechanistic", en: "A coordinated enzyme system can cleave 20 of the 21 linkage types in the complex pectin rhamnogalacturonan-II; this is digestive capacity, not proof of a direct host-health effect.", it: "Un sistema enzimatico coordinato può rompere 20 dei 21 tipi di legame della complessa pectina ramnogalatturonano-II; è capacità digestiva, non prova di un effetto diretto sulla salute." }] },
    bacteroidesVulgatus: { base: "saccharolytic", affinity: { en: "Broad glycans and bile-tolerant mixed diets", it: "Diversi glicani e diete miste con pressione biliare" }, source: SOURCES.bacteroidesVulgatus, extra: [{ domain: "metabolic", level: "association", en: "In a human cohort, B. vulgatus contributed to a microbial BCAA-biosynthesis signature linked to insulin resistance; the study did not show that changing this species alone changes glucose control.", it: "In una coorte umana, B. vulgatus contribuiva a una firma di biosintesi microbica dei BCAA associata all'insulino-resistenza; lo studio non mostra che modificare la sola specie cambi il controllo glicemico." }] },
    prevotella: { base: "saccharolytic", affinity: { en: "Whole grains and plant polysaccharides", it: "Cereali integrali e polisaccaridi vegetali" }, source: SOURCES.prevotellaContext, extra: [{ domain: "metabolic", level: "association", en: "In a human cohort, P. copri BCAA-biosynthesis potential was linked to insulin resistance; administering one isolate increased circulating BCAAs and worsened glucose tolerance in mice. This does not define every P. copri strain or plant-rich diet.", it: "In una coorte umana, il potenziale di biosintesi dei BCAA di P. copri era associato all'insulino-resistenza; un isolato somministrato aumentava i BCAA circolanti e peggiorava la tolleranza al glucosio nei topi. Non definisce ogni ceppo di P. copri né le diete ricche di vegetali." }] },
    ruminococcus: { base: "saccharolytic", affinity: { en: "Granular resistant starch; a primary degrader", it: "Amido resistente granulare; degradatore primario" }, source: SOURCES.resistantStarch, extra: [{ domain: "digestion", level: "mechanistic", en: "R. bromii opens resistant-starch particles for other community members and can determine whether a microbiota degrades RS2/RS3 efficiently; this keystone role is not itself a clinical outcome.", it: "R. bromii apre le particelle di amido resistente agli altri membri della comunità e può determinare l'efficienza di degradazione di RS2/RS3; questo ruolo chiave non è di per sé un esito clinico." }] },
    akkermansia: { base: "generalists", affinity: { en: "Host mucin; diet associations are indirect", it: "Mucina dell'ospite; le associazioni alimentari sono indirette" }, source: "https://pubmed.ncbi.nlm.nih.gov/42343233/", extra: [{ domain: "digestion", level: "mechanistic", en: "A. muciniphila specializes in mucin rather than dietary fibre; more abundance does not automatically mean a thicker or healthier mucus barrier.", it: "A. muciniphila è specializzata nella mucina, non nelle fibre alimentari; più abbondanza non implica automaticamente una barriera mucosa più spessa o sana." }, { domain: "metabolic", level: "human", en: "A 142-person trial of pasteurized MucT did not improve its primary insulin-sensitivity endpoint overall; benefits appeared only in exploratory low-baseline subgroups. Supplementation is not equivalent to a food-driven abundance shift.", it: "Un trial su 142 persone con MucT pastorizzata non ha migliorato l'endpoint primario di sensibilità insulinica nel complesso; benefici sono emersi solo in sottogruppi esplorativi con baseline bassa. La supplementazione non equivale a un aumento da cibo." }] },
    blautia: { base: "generalists", affinity: { en: "Mixed carbohydrates and community fermentation products", it: "Carboidrati misti e prodotti della fermentazione della comunità" }, source: SOURCES.blautiaWexlerae, extra: [{ domain: "metabolic", level: "preclinical", en: "B. wexlerae was inversely associated with obesity and type 2 diabetes in Japanese adults; administering it improved glucose and adiposity measures in mice through metabolic remodelling, not yet a human treatment effect.", it: "B. wexlerae era inversamente associata a obesità e diabete tipo 2 in adulti giapponesi; somministrarla ha migliorato glicemia e adiposità nei topi tramite rimodellamento metabolico, non è ancora un effetto terapeutico umano." }] },
    coprococcus: { base: "butyrate", affinity: { en: "Fermentable carbohydrates and community SCFAs", it: "Carboidrati fermentabili e SCFA della comunità" }, source: SOURCES.coprococcus, extra: [{ domain: "metabolic", level: "association", en: "In 353 adults, the Coprococcus genus was associated with higher insulin sensitivity and lower dysglycaemia prevalence after adjustment; this observational result is not a C. comes intervention.", it: "In 353 adulti, il genere Coprococcus era associato a maggiore sensibilità insulinica e minore prevalenza di disglicemia dopo aggiustamento; il risultato osservazionale non è un intervento con C. comes." }] },
    lawsonibacter: { base: "generalists", affinity: { en: "Coffee-associated compounds", it: "Composti associati al caffè" }, source: SOURCES.coffee, extra: [{ domain: "metabolic", level: "association", en: "Coffee association is highly reproducible and supported by culture work; a host-health effect of the species itself is not established.", it: "L'associazione con il caffè è molto riproducibile e supportata da colture; non è dimostrato un effetto della specie sulla salute dell'ospite." }] },
    alistipes: { base: "risk", affinity: { en: "Mixed plant and animal substrates; diet links are inconsistent", it: "Substrati vegetali e animali misti; i legami con la dieta non sono coerenti" }, source: SOURCES.alistipes, extra: [{ domain: "metabolic", level: "association", en: "Higher A. putredinis modified the association between physical activity and less long-term weight gain in two cohorts; this interaction is observational and does not establish a bacterial effect.", it: "Una maggiore A. putredinis modificava l'associazione tra attività fisica e minore aumento di peso a lungo termine in due coorti; l'interazione è osservazionale e non dimostra un effetto batterico." }] },
    parabacteroides: { base: "generalists", affinity: { en: "Plant and host glycans; produces succinate", it: "Glicani vegetali e dell'ospite; produce succinato" }, source: SOURCES.parabacteroides, extra: [{ domain: "metabolic", level: "preclinical", en: "Administered P. distasonis produced succinate and altered secondary bile acids while improving glucose and lipid measures in obese mice; comparable efficacy has not been established in humans.", it: "P. distasonis somministrata produceva succinato e modificava gli acidi biliari secondari migliorando glicemia e lipidi in topi obesi; un'efficacia comparabile non è dimostrata nell'uomo." }] },
    collinsella: { base: "generalists", affinity: { en: "Simple carbohydrates and selected host glycans", it: "Carboidrati semplici e alcuni glicani dell'ospite" }, source: SOURCES.collinsella, extra: [{ domain: "metabolic", level: "association", en: "After faecal microbiota transfer, C. aerofaciens abundance correlated with secondary bile acids; correlation does not show that this species made them or improved metabolic health.", it: "Dopo trapianto di microbiota fecale, l'abbondanza di C. aerofaciens correlava con acidi biliari secondari; la correlazione non dimostra che li abbia prodotti né che abbia migliorato la salute metabolica." }] },
    bilophila: { base: "risk", affinity: { en: "Taurine-conjugated bile and sulfur-rich conditions", it: "Bile coniugata con taurina e condizioni ricche di zolfo" }, source: SOURCES.bilophila, extra: [{ domain: "digestion", level: "mechanistic", en: "B. wadsworthia respires taurine-derived sulfite and generates hydrogen sulfide; the amount reaching host tissue depends on community consumption and detoxification.", it: "B. wadsworthia respira il solfito derivato dalla taurina e genera solfuro di idrogeno; la quantità che raggiunge i tessuti dipende da consumo e detossificazione della comunità." }, { domain: "immune", level: "preclinical", en: "Milk-fat-driven taurocholate expanded B. wadsworthia and promoted colitis only in genetically susceptible Il10−/− mice, not wild-type mice; this is not evidence that the species is intrinsically harmful in humans.", it: "Il taurocolato indotto dal grasso del latte espandeva B. wadsworthia e favoriva colite solo in topi Il10−/− suscettibili, non nei wild-type; non prova che la specie sia intrinsecamente nociva nell'uomo." }] },
    escherichia: { base: "risk", affinity: { en: "Oxygen and nitrate available during ecological disturbance", it: "Ossigeno e nitrato disponibili durante perturbazioni ecologiche" }, source: SOURCES.escherichia, extra: [{ domain: "immune", level: "strain", en: "E. coli spans ordinary commensals, probiotic Nissle and multiple pathovars. In gnotobiotic mice, different commensal strains produced markedly different IL-6-dependent colitis severity despite similar abundance.", it: "E. coli comprende comuni commensali, il probiotico Nissle e diversi patotipi. Nei topi gnotobiotici, ceppi commensali diversi producevano gravità di colite IL-6-dipendente molto diversa nonostante abbondanze simili." }] },
    enterococcus: { base: "risk", affinity: { en: "Protein-rich substrates and oxygen-tolerant niches", it: "Substrati ricchi di proteine e nicchie tolleranti all'ossigeno" }, source: SOURCES.enterococcus, extra: [{ domain: "neuro", level: "mechanistic", en: "Some E. faecalis strains decarboxylate tyrosine to tyramine, particularly at low pH; tyramine production is strain-dependent and does not demonstrate brain dopamine production or a mood effect.", it: "Alcuni ceppi di E. faecalis decarbossilano la tirosina in tiramina, soprattutto a pH basso; la produzione dipende dal ceppo e non dimostra produzione di dopamina cerebrale né un effetto sull'umore." }] }
  };
